...
public class UserInfoDB {
  ...
  private static Map<String, UserDetails> userinfos = new HashMap<String, UserDetails>();
  ...
  public static void addUserInfo(String name, String email, String password) {
    userinfos.put(email, new UserDetails(name, email, password));
  }
   ...
   * @return The UserInfo.
   */
  public static UserDetails getUser(String email) {
